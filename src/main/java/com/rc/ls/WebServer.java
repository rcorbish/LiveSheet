...
public class WebServer {
	...
	private Handler getSheetHandler() {
	...
	public static class SheetDataServlet extends WebSocketServlet {		 
		@Override
		public void configure(WebSocketServletFactory factory) {
			factory.register(SheetWebSocket.class);
		}
	}

	private Handler getSheetDataHandler() {
